    ...
    <div> 
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Existing Location Details</h3>
                <button class="btn btn-success btn-sm fa-pull-right" type="button" @click="showmodal()"><span class="fa fa-plus"> Add New Location</span></button>
            </div>
            <div class="card-body">
							...
							<form class="bootbox-form">
								<div class="row">
									<div class="col-xs-12 alert alert-danger">
										<span class="">Are you sure you wish to delete the location?</span>
