<template>
    <div>
        <form>
                ...
                <div class="card-header">
                    ...
                    <div class="card-body" >
                        <div class="form-group row">
                            ...
                            <div class="col-md-5">
                            <label class="col-md-5 font-weight-normal">Year of Upgrade:</label>
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">After Update</h3>
                </div>
...
data(){
    ...
    methods:{
        ...
        if(organization == 1){
                ...
                $("#parentSchool option:selected").text("");
                $("#coLoParent option:selected").text("");
