            ...
            <div class="">
                <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                    <ol class="breadcrumb"> 
                        ...
                        <li class="breadcrumb-item active">Gewog</li>
                    </ol>
                </div>
                <div class="row"> 
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Existing Gewog Details</h3>
							...
							<form class="bootbox-form">
								<div class="row">
									<div class="col-12 alert alert-danger">
										<span class="">Are you sure you wish to delete the selected Gewog?</span>
